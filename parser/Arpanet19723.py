...
class GeneratedTopo( Topo ):
    ...
    def __init__( self, **opts ):
        ...
        self.addLink( s1 , s25, bw=10, delay='44ms')
        self.addLink( s1 , s23, bw=10, delay='16ms')
        self.addLink( s2 , s3, bw=10, delay='34ms')
        self.addLink( s2 , s5, bw=10, delay='19ms')
        self.addLink( s3 , s4, bw=10, delay='50ms')
        self.addLink( s4 , s11, bw=10, delay='25ms')
        self.addLink( s4 , s6, bw=10, delay='11ms')
        self.addLink( s5 , s8, bw=10, delay='31ms')
        self.addLink( s7 , s25, bw=10, delay='16ms')
        self.addLink( s7 , s16, bw=10, delay='45ms')
        self.addLink( s8 , s17, bw=10, delay='10ms')
        self.addLink( s9 , s22, bw=10, delay='12ms')
        self.addLink( s9 , s16, bw=10, delay='16ms')
        self.addLink( s10 , s18, bw=10, delay='2ms')
        self.addLink( s10 , s14, bw=10, delay='39ms')
        self.addLink( s11 , s24, bw=10, delay='20ms')
        self.addLink( s12 , s18, bw=10, delay='48ms')
        self.addLink( s12 , s23, bw=10, delay='7ms')
        self.addLink( s13 , s20, bw=10, delay='12ms')
        self.addLink( s13 , s21, bw=10, delay='46ms')
        self.addLink( s13 , s15, bw=10, delay='12ms')
        self.addLink( s14 , s21, bw=10, delay='11ms')
        self.addLink( s15 , s22, bw=10, delay='34ms')
        self.addLink( s16 , s17, bw=10, delay='43ms')
        self.addLink( s18 , s19, bw=10, delay='6ms')
        self.addLink( s19 , s20, bw=10, delay='48ms')
        self.addLink( s22 , s23, bw=10, delay='6ms')
        self.addLink( s24 , s25, bw=10, delay='10ms')
